...
/** Local calendar date (YYYY-MM-DD) and weekday index (0=Sun..6=Sat) for a
 * UTC instant — used by the award-rate projection to tell which day-of-week
 * penalty rate applies to a given shift. Not trading-day-rollover-aware
 * (that's deliberate — award penalty rates key off the actual calendar day
 * the work happens on, not the venue's trading-day boundary). */
